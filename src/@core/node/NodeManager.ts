...
import { INodeList, NodeList } from '@core/node/NodeList';
import { INodePool, NodePool } from '@core/node/NodePool';
...
export class NodeManager implements INodeManager {
  ...
  constructor(private readonly node: typeof Node) {
    ...
    const metadata: Array<typeof Components> = Reflect.getMetadata(__COMPONENTS__, node.prototype);
    if (metadata) {
